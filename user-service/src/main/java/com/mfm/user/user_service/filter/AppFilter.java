package com.mfm.user.user_service.filter;
...
public class AppFilter {
    ...
    @Bean
    public FilterRegistrationBean<AppFilterIntercept> traceFilter() {
    ...
    static class AppFilterIntercept extends OncePerRequestFilter {
        ...
        protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
            ...
            try {
                ...
                MDC.put(TRACE_ID, traceId); // Add traceId to Mapped Diagnostic Context
